...
- **Scintillation**: Young (1967), same formula as §5.2, using the RC20's own 0.51m aperture / 560m site altitude (ETH Zürich); extended-source-suppressed per §7.08.
